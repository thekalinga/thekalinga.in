...
We still have no idea why any decision is made the way its made in _collegium system_[^collegium-system], but still Judiciary gives itself self-certificates about "greater transparency". Everyone knows the essential element needed to move to higher in the food chain within Indian Judiciary is lobbying of politicians & Judges --- both influence peddling. I personally heard atleast one case (from trusted lawyers) cash changed hand i.e open corruption.

Since Indian Judiciary has weaponized Contempt of Court procedure to attack whistleblowers & shield itself from accountability, what's the basis for these claims about alleged transparency (self-certification) --- let alone "greater transparency"?
