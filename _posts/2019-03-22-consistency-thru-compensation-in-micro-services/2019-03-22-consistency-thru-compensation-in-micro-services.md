...
2. On demand reconciliation: Orders requested by client is guaranteed to be consistent thru on demand reconciliation once the request is processed successfully (optional)
