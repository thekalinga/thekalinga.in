...
demographic selection, but we atleast have these details. Polls with these details are "somewhat"
legitimate.

No poll thats done in secrecy where all aspects are not open for public scrutiny
can be that that reliable, let alone accurate. This is not to say that no poll gives the general sense
of what people feel, but just that those polls where the pollsters have inherent self interest of the results
